...
namespace AdventOfCode.Challenges
{
    public partial class Challenges
    {
        ...
        {
            string[] strInput = Program.handleInput(4);
            var boards = generateBoards(strInput);
        ...
        {
            var boards = new List<List<List<int>>>((strInput.Length - 1) / 6);
            
            for (int i = 0; i < boards.Capacity; i++)
            {
                var board = new List<List<int>>(5);
